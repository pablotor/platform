...
const Hero = () => {
  return (
    <section className="relative mx-auto flex min-h-[calc(100vh-4rem)] max-w-5xl flex-col items-center justify-center px-6 py-20 text-center">
      ...
      <h1 className="max-w-3xl text-balance text-4xl font-bold leading-tight tracking-tight sm:text-6xl">
        ...
        <span className="gradient-text animate-switch-gradient">
          tech utopia
        </span>
        .
      </h1>
